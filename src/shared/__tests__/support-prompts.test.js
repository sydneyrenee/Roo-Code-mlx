...
describe("Code Action Prompts", () => {
    ...
    describe("ENHANCE action", () => {
        it("should format enhance prompt correctly", () => {
            ...
            expect(prompt).toBe("Generate an enhanced version of this prompt (reply with only the enhanced prompt - no conversation, explanations, lead-in, bullet points, placeholders, or surrounding quotes):\n\ntest");
...
//# sourceMappingURL=support-prompts.test.js.map