...
exports.supportPromptDescriptions = exports.supportPromptLabels = exports.supportPrompt = exports.createPrompt = void 0;
...
exports.supportPromptLabels = Object.fromEntries(Object.entries(supportPromptConfigs).map(([key, config]) => [key, config.label]));
exports.supportPromptDescriptions = Object.fromEntries(Object.entries(supportPromptConfigs).map(([key, config]) => [key, config.description]));
