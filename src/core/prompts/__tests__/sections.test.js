...
describe("addCustomInstructions", () => {
    test("adds preferred language to custom instructions", async () => {
        const result = await addCustomInstructions("mode instructions", "global instructions", "/test/path", "test-mode", { preferredLanguage: "French" });
...
describe("getCapabilitiesSection", () => {
    ...
    const mockDiffStrategy = {
        ...
        applyDiff: async (originalContent, diffContent) => {
