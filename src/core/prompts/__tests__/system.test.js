...
describe("SYSTEM_PROMPT", () => {
    ...
    it("should use promptComponent roleDefinition when available", async () => {
        ...
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, undefined, undefined, defaultModeSlug, customModePrompts, undefined, undefined, undefined, undefined, experiments, true);
    ...
    describe("experimental tools", () => {
        ...
        it("should list all available editing tools in base instruction", async () => {
            ...
            const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, new SearchReplaceDiffStrategy(), undefined, defaultModeSlug, undefined, undefined, undefined, undefined, true, // diffEnabled
            experiments, true);
        ...
        it("should provide detailed instructions for each enabled tool", async () => {
            ...
            const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, new SearchReplaceDiffStrategy(), undefined, defaultModeSlug, undefined, undefined, undefined, undefined, true, experiments, true);
            // Verify detailed instructions for each tool
            expect(prompt).toContain("You should always prefer using other editing tools over write_to_file when making changes to existing files since write_to_file is much slower and cannot handle large files.");
...
describe("addCustomInstructions", () => {
    ...
    it("should generate correct prompt for architect mode", async () => {
        ...
        undefined, // customModePrompts
        undefined, // customModes
        undefined, undefined, undefined, experiments, true);
        expect(prompt).toMatchSnapshot();
    });
    ...
    it("should combine all custom instructions", async () => {
        const instructions = await addCustomInstructions("Custom test instructions", "", "/test/path", defaultModeSlug, { preferredLanguage: "French" });
        expect(instructions).toMatchSnapshot();
    });
