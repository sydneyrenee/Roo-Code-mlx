...
describe("ConfigManager", () => {
    ...
    describe("initConfig", () => {
        ...
        it("should throw error if secrets storage fails", async () => {
            ...
            await expect(configManager.initConfig()).rejects.toThrow("Failed to initialize config: Error: Failed to read config from secrets: Error: Storage failed");
        });
    });
    describe("ListConfig", () => {
        ...
        it("should throw error if reading from secrets fails", async () => {
            ...
            await expect(configManager.listConfig()).rejects.toThrow("Failed to list configs: Error: Failed to read config from secrets: Error: Read failed");
        });
    });
    describe("SaveConfig", () => {
        it("should save new config", async () => {
            ...
            expect(mockSecrets.store).toHaveBeenCalledWith("roo_cline_config_api_config", JSON.stringify(expectedConfig, null, 2));
        });
        ...
        it("should throw error if secrets storage fails", async () => {
            ...
            await expect(configManager.saveConfig("test", {})).rejects.toThrow("Failed to save config: Error: Failed to write config to secrets: Error: Storage failed");
        });
    });
    describe("DeleteConfig", () => {
        ...
        it("should throw error when trying to delete last remaining config", async () => {
            ...
            await expect(configManager.deleteConfig("default")).rejects.toThrow("Cannot delete the last remaining configuration.");
        });
    });
    describe("LoadConfig", () => {
        ...
        it("should throw error if secrets storage fails", async () => {
            ...
            mockSecrets.store.mockRejectedValueOnce(new Error("Storage failed"));
            await expect(configManager.loadConfig("test")).rejects.toThrow("Failed to load config: Error: Failed to write config to secrets: Error: Storage failed");
        });
    });
    describe("SetCurrentConfig", () => {
        ...
        it("should throw error when config does not exist", async () => {
            ...
            await expect(configManager.setCurrentConfig("nonexistent")).rejects.toThrow("Config 'nonexistent' not found");
        });
        it("should throw error if secrets storage fails", async () => {
            mockSecrets.get.mockResolvedValue(JSON.stringify({
                currentApiConfigName: "default",
            ...
            mockSecrets.store.mockRejectedValueOnce(new Error("Storage failed"));
            await expect(configManager.setCurrentConfig("test")).rejects.toThrow("Failed to set current config: Error: Failed to write config to secrets: Error: Storage failed");
        });
    });
    ...
    describe("HasConfig", () => {
        ...
        it("should throw error if secrets storage fails", async () => {
            mockSecrets.get.mockRejectedValue(new Error("Storage failed"));
            await expect(configManager.hasConfig("test")).rejects.toThrow("Failed to check config existence: Error: Failed to read config from secrets: Error: Storage failed");
        });
    });
});
