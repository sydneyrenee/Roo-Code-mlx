...
exports.SearchReplaceDiffStrategy = void 0;
...
<end_line>5</end_line>
    ...
    async applyDiff(originalContent, diffContent, startLine, endLine) {
        ...
        if ((0, extract_text_1.everyLineHasLineNumbers)(searchContent) && (0, extract_text_1.everyLineHasLineNumbers)(replaceContent)) {
...
exports.SearchReplaceDiffStrategy = SearchReplaceDiffStrategy;
