...
describe("McpHub", () => {
    ...
    describe("server disabled state", () => {
        ...
        it("should prevent calling tools on disabled servers", async () => {
            ...
            await expect(mcpHub.callTool("disabled-server", "some-tool", {})).rejects.toThrow('Server "disabled-server" is disabled and cannot be used');
        });
        it("should prevent reading resources from disabled servers", async () => {
            ...
            mcpHub.connections = [mockConnection];
            await expect(mcpHub.readResource("disabled-server", "some/uri")).rejects.toThrow('Server "disabled-server" is disabled');
        });
    });
    describe("callTool", () => {
