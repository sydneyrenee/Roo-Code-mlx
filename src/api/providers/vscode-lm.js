...
class VsCodeLmHandler {
    ...
    constructor(options) {
        ...
        try {
            ...
            this.dispose();
            throw new Error(`Roo Code <Language Model API>: Failed to initialize handler: ${error instanceof Error ? error.message : "Unknown error"}`);
        }
    }
    /**
    ...
    async *createMessage(systemPrompt, messages) {
        ...
        try {
            ...
            yield {
                ...
                totalCost: (0, cost_1.calculateApiCost)(this.getModel().info, totalInputTokens, totalOutputTokens),
            };
        }
        catch (error) {
            this.ensureCleanState();
        ...
        if (this.client) {
            ...
            const modelInfo = {
                ...
                contextWindow: typeof this.client.maxInputTokens === "number"
                    ...
                    : api_1.openAiModelInfoSaneDefaults.contextWindow,
