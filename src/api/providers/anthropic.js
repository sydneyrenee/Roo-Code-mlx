...
class AnthropicHandler {
    ...
    getModel() {
        ...
        if (modelId && modelId in api_1.anthropicModels) {
            const id = modelId;
            return { id, info: api_1.anthropicModels[id] };
        }
        return { id: api_1.anthropicDefaultModelId, info: api_1.anthropicModels[api_1.anthropicDefaultModelId] };
    }
