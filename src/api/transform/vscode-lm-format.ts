...
export async function convertVSCodeToAnthropicMessage(
...
function createTextBlock(text: string): Anthropic.Messages.TextBlockParam {
    return {
        type: "text",
        text: text,
        citations: null
...
export function createSimpleAnthropicMessage(text: string): Anthropic.Messages.MessageParam {
    return {
        role: "assistant",
